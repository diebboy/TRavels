...
let slider_travels = new Swiper('.slider-travels', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
   ...
   */
   ...
   // Dotts
   pagination: {
      el: '.navigation-slider__pag',
      clickable: true,
      type: 'fraction',
      renderFraction: function (currentClass, totalClass) {
         return '0'+'<span class="' + currentClass + '"></span>' +
         '/'+'<span class=" + pagination-null + ">0</span>'+
            '<span class="' + totalClass + '"></span>';
      },
   },
   // Arrows
   navigation: {
      nextEl: '.navigation-slider__arrow-next',
      prevEl: '.navigation-slider__arrow-prev',
   },
   /*
   breakpoints: {
      320: {
...
//=================
//Menu
let iconMenu = document.querySelector(".home-icon");
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".home__menu");
